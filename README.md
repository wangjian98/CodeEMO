...
|------|-----|------|-----------|---------|----------|--------|
| HDM-Net | **0.8965 ± 0.013** | **0.9268 ± 0.017** | 0.9257 ± 0.016 | 0.8694 ± 0.019 | 0.8668 ± 0.016 | 33,220 |
| (vs 上轮最强 RF-7dim) | (+0.009) | (+0.009) | — | — | — | ×3 |
...
**为什么 work**：单模型上 AUC=0.927 双榜超越 Late Fusion 5-way=0.922；表示“异构分支 + per-student gating” 的确比加权平均 “多通道独立模型结果” 高出多个 F1 点。
...
| 指标 | 数值 | 对比单模型最佳 |
|------|------|---------------|
| **F1** | **0.9056 ± 0.015** | +0.009（vs HDM-Net 0.8965） |
| **AUC** | 0.9222 ± 0.011 | -0.005（vs HDM-Net 0.9268） |
