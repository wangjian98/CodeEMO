# HDM-Net v2 (4-branch XCA + PIG, 33,220 params) — Standalone Runner

HDM-Net v2 (4-branch XCA + PIG, 33,220 params) for the CS1 MOOC student-outcome prediction task.

## Run

```bash
cd model_new/hdm_net
...
```
model_new/hdm_net/outputs/hdm_net/results.json
```
