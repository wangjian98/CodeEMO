# Transformer (multi-head self-attention) — Standalone Runner

Transformer (multi-head self-attention) for the CS1 MOOC student-outcome prediction task.

## Run

```bash
cd model_new/transformer
...
```
model_new/transformer/outputs/transformer/results.json
```
